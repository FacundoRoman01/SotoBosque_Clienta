      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="font-sans text-xs font-light text-[#F7F4F0]/70 mb-3 leading-relaxed">
              Seguinos en Instagram y descubrí momentos, paisajes y experiencias únicas en Cabañas Sylviane.
            </p>
            <div className="flex gap-2">
              <a
                href="https://www.instagram.com/bosque.bonita.mdq/"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2.5 bg-[#435843] text-[#F7F4F0] rounded-xl hover:bg-[#F7F4F0] hover:text-[#435843] transition-all"
                aria-label="Instagram de Bosque Bonita"
              >
